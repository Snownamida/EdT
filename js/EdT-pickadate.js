...
String.prototype.split = function (a, b) {
  ...
  var d,
    ...
    j = 0;
  for (
    a = new RegExp(a.source, i + "g"),
      c += "",
      compliantExecNpcg || (d = new RegExp("^" + a.source + "$(?!\\s)", i)),
      b = void 0 === b ? -1 >>> 0 : b >>> 0;
    (e = a.exec(c)) &&
    ...
    !(
      ...
      e.length > 1 &&
        e.index < c.length &&
        Array.prototype.push.apply(h, e.slice(1)),
      (g = e[0].length),
      (j = f),
      h.length >= b)
    ));
  ...
  return (
    j === c.length ? (g || !a.test("")) && h.push("") : h.push(c.slice(j)),
    h.length > b ? h.slice(0, b) : h
  );
};
